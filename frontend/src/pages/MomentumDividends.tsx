...
const INITIAL_STOCKS: MomentumDividendStock[] = [
  {
    ...
    pb_ratio: 1.4,
    momentum_score: 82,
    ai_recommendation_reason: 'Deep value bargain pricing with 54.0% Intrinsic Fair Value upside (₹152.13) and strong ethanol blend policy cash flows.',
    detailed_explanation: {
      ...
      why_invest: 'Bargain Valuation & High Safety Margin: Stock trades at a 54.0% discount to intrinsic fair value (₹152.13) with low P/E multiple (12.9x). Piotroski Health Score is 8/9 with minimal Debt-to-Equity (0.15) and zero promoter share pledge.',
  ...
  },
  {
    ...
    detailed_explanation: {
      ...
      why_invest: 'High Relative Price Momentum (+22.8% 1-Month) combined with 28.5% intrinsic fair value upside (Target ₹105.99). Network expanding to 250+ dispensing stations with high institutional DII/FII buying interest.',
  ...
  },
  {
    ...
    pb_ratio: 0.8,
    momentum_score: 91,
    ai_recommendation_reason: 'Highest momentum score (91/100) with 53.6% intrinsic valuation upside and debt monetization catalysts.',
    detailed_explanation: {
      ...
      why_invest: 'Highest momentum rating (91/100) with 53.6% intrinsic fair value upside (Fair Value ₹350.14). Rapid debt reduction via non-core land bank asset monetization.',
